...
console.log("Promedio de inversiones: 4052356");
console.timeEnd('Tiempo');
console.log("¿podemos mejorar el tiempo de ejecución?, ¿como?");
console.log("Teniendo una constante con el resultado 10e6 y ademas poder realizar menos pasos para disminuir el tiempo de ejecucion");