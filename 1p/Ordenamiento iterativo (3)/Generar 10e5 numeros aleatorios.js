...
console.log("Promedio de inversiones: 555360.333");
console.timeEnd('Tiempo');
console.log("¿podemos mejorar el tiempo de ejecución?, ¿como?");
console.log("Teniendo una constante con el resultado 10e5 y ademas poder realizar menos pasos para disminuir el tiempo de ejecucion");