class Graph {
  ...
  console.log('Tamaño del grafo, numero de vertices:', graph.size()); // => 6
  console.log("Removemos un vertice y nos quedan:")
  graph.removeVertex(5);
  console.log('Tamaño del grafo, numero de vertices:', graph.size()); // => 5
graph.print();